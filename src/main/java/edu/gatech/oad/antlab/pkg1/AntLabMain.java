 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Elina Ebby");
		  toPrint += p1.toString("eebby3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Nicholas Brown");
		  toPrint += p2.toString("nbrown88");
          ...
          Person4 p4 = new Person4("Najaah Chambliss");
          toPrint += p4.toString("nchambliss3");
